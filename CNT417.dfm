object FSelTDiario: TFSelTDiario
  Left = 348
  Top = 129
  BorderIcons = [biSystemMenu, biMaximize]
  BorderStyle = bsDialog
  Caption = 'Seleccione Tipos de Diario'
  ClientHeight = 553
  ClientWidth = 522
  Color = 14869218
  ...
  object pnlPendientes: TPanel
    ...
    object dbgPendientes: TwwDBGrid
      ...
      Selected.Strings = (
        'TDIARID'#9'15'#9'T. Diario'
        'TDIARDES'#9'40'#9'Descripci'#243'n'
        'TDIARABR'#9'20'#9'Abr.')
    ...
    object pnlBusca: TPanel
      ...
      object lblBusca: TLabel
        ...
        Width = 135
        Height = 15
        Caption = 'Nombre del Tipo de Diario'
      end
  ...
  object pnlDocCanje: TPanel
    ...
    object Label17: TLabel
      ...
      Align = alTop
      Alignment = taCenter
      Caption = 'Tipos de Diario Escogidos'
      Color = clActiveCaption
      Font.Charset = ANSI_CHARSET
      Font.Color = clWhite
      Font.Height = -13
