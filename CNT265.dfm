object FInconsistencias: TFInconsistencias
  ...
  object bbtnLista: TBitBtn
    ...
    Width = 146
    Height = 28
    Caption = 'Imprimir Inconsistencias'
    TabOrder = 0
  ...
  object ppRepIncons: TppReport
    AutoStop = False
    DataPipeline = ppDBIncons
    ...
    Template.FileName = 'C:\SolExes\SOLFormatos\Cnt\Dema\Inconsistencias.rtm'
    DeviceType = 'Screen'
  ...
  object ppDBIncons: TppDBPipeline
    UserName = 'DBIncons'
    Left = 280
    Top = 8
  end
