...
uses
  ...
  Spin, wwdblook, ComCtrls, ExtCtrls, oaVariables;
 ...
 //**
  ...
  begin
    ...
    Begin
       ...
       If DM1.cdsVariable.FieldByName('SALDMN12').AsFloat<0  then
          DM1.cdsCNT311.FieldByName('CNTMTOORI').AsFloat:=(-1)*(DM1.cdsVariable.FieldByName('SALDMN12').AsFloat)
       else
          DM1.cdsCNT311.FieldByName('CNTMTOORI').AsFloat:=DM1.cdsVariable.FieldByName('SALDMN12').AsFloat;

       If DM1.cdsVariable.FieldByName('SALDMN12').AsFloat< 0 then
          DM1.cdsCNT311.FieldByName('CNTMTOLOC').AsFloat:=(-1)*DM1.cdsVariable.FieldByName('SALDMN12').AsFloat
       else
          DM1.cdsCNT311.FieldByName('CNTMTOLOC').AsFloat:=DM1.cdsVariable.FieldByName('SALDMN12').AsFloat;

       If DM1.cdsVariable.FieldByName('SALDMN12').AsFloat < 0 then
          DM1.cdsCNT311.FieldByName('CNTMTOEXT').AsFloat:=(-1)*(DM1.cdsVariable.FieldByName('SALDMN12').AsFloat)/ StrToFloat(xTcambio) //cdsVariable.FieldByName('SALDME12').AsFloat;
       else
          DM1.cdsCNT311.FieldByName('CNTMTOEXT').AsFloat:=DM1.cdsVariable.FieldByName('SALDMN12').AsFloat / StrToFloat(xTcambio); //cdsVariable.FieldByName('SALDME12').AsFloat;

       If DM1.cdsVariable.FieldByName('SALDMN12').AsFloat > 0 then
       begin
          DM1.cdsCNT311.FieldByName('CNTDEBEMN').AsFloat  := DM1.cdsVariable.FieldByName('SALDMN12').AsFloat;
          DM1.cdsCNT311.FieldByName('CNTDEBEME').Asfloat  := DM1.cdsVariable.FieldByName('SALDMN12').AsFloat / StrToFloat(xTCambio);
       end
       else begin
          DM1.cdsCNT311.FieldByName('CNTHABEMN').AsFloat  := (-1)*DM1.cdsVariable.FieldByName('SALDMN12').AsFloat;
          DM1.cdsCNT311.FieldByName('CNTHABEME').AsFloat  := (-1)*(DM1.cdsVariable.FieldByName('SALDMN12').AsFloat)  / StrToFloat(xTCambio);
       end;
    end;
