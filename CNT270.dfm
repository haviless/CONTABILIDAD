object FApertura: TFApertura
  ...
  object Panel1: TPanel
    ...
    object gbAApe: TGroupBox
      ...
      object cbAux: TCheckBox
        Left = 12
        Top = 160
        Width = 149
        Height = 17
        Caption = 'Detalle de Auxiliares'
        Checked = True
        Enabled = False
        State = cbChecked
        TabOrder = 8
    ...
    object bbtnMov: TBitBtn
      ...
      Width = 150
      Height = 25
      Caption = 'Inconsistencias Movimientos'
      TabOrder = 7
      OnClick = bbtnMovClick
    end
    object bbtnPlan: TBitBtn
      Left = 162
      Top = 280
      Width = 150
      Height = 25
      Caption = 'Inc.Otras Cias a Cia Consol'
      TabOrder = 8
      OnClick = bbtnPlanClick
    end
    object bbtnPlan2: TBitBtn
      Left = 162
      Top = 308
      Width = 150
      Height = 25
      Caption = 'Inc.Cia Consol a Otras Cias'
      TabOrder = 9
      OnClick = bbtnPlan2Click
    end
  end
  ...
  object pprInc: TppReport
    ...
    Template.FileName = 'C:\oaEjecuta\RTMs\Cnt\Dema\ConsistenciaAperturaPlanConsol.rtm'
    DeviceType = 'Screen'
